...
const getThemedStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  goalChipActive: { borderColor: c.accent.primary, backgroundColor: c.accent.primaryMuted },
  goalChipText: { color: c.text.secondary, fontSize: typography.size.sm },
  goalChipTextActive: { color: c.accent.primary, fontWeight: typography.weight.medium },
  inputGroup: { marginTop: spacing[3] },
  inputLabel: { color: c.text.secondary, fontSize: typography.size.sm, marginBottom: spacing[1] },
  input: {
    backgroundColor: c.bg.surfaceRaised, borderRadius: radius.md,
    borderWidth: 1, borderColor: c.border.default,
    padding: spacing[3], color: c.text.primary, fontSize: typography.size.md,
  },
  ...
  backText: { color: c.text.muted, fontSize: typography.size.sm },
});
