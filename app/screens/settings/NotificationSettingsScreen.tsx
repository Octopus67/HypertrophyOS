...
export function NotificationSettingsScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']} testID="notification-settings-screen">
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <Card>
          <View style={styles.row}>
            ...
            {permissionStatus === 'granted' && (
              <View style={styles.statusBadge} testID="permission-granted-badge">
          ...
          {TOGGLE_ITEMS.map((item) => (
            <View key={item.key} style={styles.toggleRow} testID={`toggle-${item.key}`}>
              ...
              <Switch
                ...
                trackColor={{ false: colors.border.default, true: colors.accent.primaryMuted }}
                thumbColor={prefs[item.key] ? colors.accent.primary : colors.text.muted}
        ...
        <Card>
          <View style={styles.toggleRow}>
            ...
            <Switch
              ...
              trackColor={{ false: colors.border.default, true: colors.accent.primaryMuted }}
              thumbColor={prefs.quiet_hours_start ? colors.accent.primary : colors.text.muted}
