"""Seed script to insert the social_sharing feature flag.

Usage:
    DATABASE_URL=sqlite+aiosqlite:///./test.db \
        .venv/bin/python -m src.modules.feature_flags.seed_social_sharing
"""
...
FLAG_NAME = "social_sharing"
FLAG_DESCRIPTION = (
    "Gates viral growth features: QR codes, referral links, "
    "user attribution, and share analytics on workout share cards"
)
